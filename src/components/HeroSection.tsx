...
export default function HeroSection() {
  ...
  const { scrollYProgress } = useScroll();
    ...
    const leftX = useTransform(scrollYProgress, [0, 1], [-10, -30]);
  const rightX = useTransform(scrollYProgress, [0, 1], [10, 30]);
  const topY = useTransform(scrollYProgress, [0, 1], [-10, -40]);
  const bottomY = useTransform(scrollYProgress, [0, 1], [10, 40]);
